...
export default function Layout({ children, session, hideNav = false }) {
  ...
  const navItems = [
    { label: 'Cockpit', path: '/dashboard', icon: (
    ...
    { label: 'Relays', path: '/relays', icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M4 12h16"/><circle cx="6" cy="12" r="2.5"/><circle cx="18" cy="12" r="2.5"/><path d="M9 12h6"/></svg>
    )},
    { label: 'Capacity', path: '/capacity', icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" y1="22" x2="4" y2="15"/></svg>
    )},
    { label: 'Restructure', path: '/restructure', icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M3 10h18"/><path d="M9 10v10"/><path d="M15 10v10"/></svg>
    )},
    { label: 'Registers', path: '/registers', icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
    )},
    { label: 'Ghosts', path: '/ghosts', icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 2a7 7 0 0 0-7 7v12l2.5-2 2.5 2 2-2 2 2 2.5-2 2.5 2V9a7 7 0 0 0-7-7z"/><circle cx="9.5" cy="10" r="1"/><circle cx="14.5" cy="10" r="1"/></svg>
    )},
    ...
    <div className="layout-root">
      {!hideNav && (
        <aside className="mockup-sidebar no-print">
          <div className="sidebar-pill" style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
            <div className="sidebar-header">
              <div className="logo-box">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--accent-cyan)' }}>
                  <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z" />
                  <circle cx="12" cy="12" r="3" fill="var(--accent-amber)" stroke="none" />
                </svg>
              </div>
            </div>

            <nav className="sidebar-nav custom-scrollbar" style={{ overflowY: 'auto', flex: 1, paddingRight: '4px', marginTop: '8px' }}>
              {navItems.map(item => {
                ...
                return (
                  ...
                  >
                    {isActive && <div className="nav-indicator-bar"></div>}
            ...
            <div className="sidebar-footer" style={{ marginTop: 'auto', paddingTop: '2rem', textAlign: 'center' }}>
              <div style={{ fontSize: '0.65rem', fontWeight: 900, color: 'var(--accent-cyan)', opacity: 0.5, letterSpacing: '0.1em' }}>

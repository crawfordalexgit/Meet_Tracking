 ...
 * Handles "Last, First" -> "First Last" and removes extra whitespace/casing.
 */
export function normalizeName(name) {
  ...
  // We strip the alias for the base normalization but we'll handle it in the matcher
  n = n.replace(/\s*\([^)]*\)\s*/g, ' ');
...
/**
 * Generates all valid name permutations for a swimmer to ensure robust matching.
 */
...
/**
 * Returns the preferred name for a swimmer (Known As + Last Name).
 * Falls back to full_name if known_as is missing.
 */
...
/**
 * Normalizes an event string (e.g. "Event 104 Boys 50m Breaststroke" -> "50m breaststroke")
 */
...
export const DEFAULT_EXEMPTIONS = [
  // 2025 August Shutdown (Credit)
  { name: 'August Shutdown', start_date: '2025-08-25', end_date: '2025-08-31', type: 'credit' },
  // 2026 August Shutdown (Credit)
  { name: 'August Shutdown', start_date: '2026-08-25', end_date: '2026-08-31', type: 'credit' },
  
  // 2025 Christmas Shutdown (Credit)
  { name: 'Christmas Shutdown', start_date: '2025-12-22', end_date: '2025-12-28', type: 'credit' },
  // 2026 Christmas Shutdown (Credit)
  { name: 'Christmas Shutdown', start_date: '2026-12-22', end_date: '2026-12-28', type: 'credit' },

  // 2025 Bank Holidays (Credit)
  { name: 'New Year Bank Holiday', start_date: '2025-01-01', end_date: '2025-01-01', type: 'credit' },
  { name: 'Good Friday', start_date: '2025-04-18', end_date: '2025-04-18', type: 'credit' },
  { name: 'Easter Monday', start_date: '2025-04-21', end_date: '2025-04-21', type: 'credit' },
  { name: 'Early May Bank Holiday', start_date: '2025-05-05', end_date: '2025-05-05', type: 'credit' },
  { name: 'Spring Bank Holiday', start_date: '2025-05-26', end_date: '2025-05-26', type: 'credit' },
  { name: 'Summer Bank Holiday', start_date: '2025-08-25', end_date: '2025-08-25', type: 'credit' },
  { name: 'Christmas Day', start_date: '2025-12-25', end_date: '2025-12-25', type: 'credit' },
  { name: 'Boxing Day', start_date: '2025-12-26', end_date: '2025-12-26', type: 'credit' },

  // 2026 Bank Holidays (Credit)
  { name: 'New Year Bank Holiday', start_date: '2026-01-01', end_date: '2026-01-01', type: 'credit' },
  { name: 'Good Friday', start_date: '2026-04-03', end_date: '2026-04-03', type: 'credit' },
  { name: 'Easter Monday', start_date: '2026-04-06', end_date: '2026-04-06', type: 'credit' },
  { name: 'Early May Bank Holiday', start_date: '2026-05-04', end_date: '2026-05-04', type: 'credit' },
  { name: 'Spring Bank Holiday', start_date: '2026-05-25', end_date: '2026-05-25', type: 'credit' },
  { name: 'Summer Bank Holiday', start_date: '2026-08-31', end_date: '2026-08-31', type: 'credit' },
  { name: 'Christmas Day', start_date: '2026-12-25', end_date: '2026-12-25', type: 'credit' },
  { name: 'Boxing Day', start_date: '2026-12-28', end_date: '2026-12-28', type: 'credit' },

  // Easter Holidays (Credit)
  { name: 'Easter Holidays', start_date: '2025-04-14', end_date: '2025-04-17', type: 'credit' },
  { name: 'Easter Holidays', start_date: '2026-03-30', end_date: '2026-04-02', type: 'credit' }
];
  ...
  const totalWeeksCount = Math.floor(daysInSquad / 7);
   ...
   for (let i = 0; i < totalWeeksCount; i++) {
     ...
     if (isExemptWeek) {
      ...
      const finalWeekTargetHrs = Math.max(0, targetHrs - creditedHoursInWeek);
     ...
     if (w || creditedSessionsInWeek > 0) {
       ...
       if (creditedSessionsInWeek > 0) {
        ...
        if (filterOptions.complianceMode === 'sessions') {
          activityMet = sessMet;
        } else if (filterOptions.complianceMode === 'hours') {
          activityMet = hrsMet;
        } else {

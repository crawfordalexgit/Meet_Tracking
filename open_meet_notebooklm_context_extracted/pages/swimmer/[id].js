...
export default function SwimmerDetail({ session }) {
  ...
  return (
    <Layout session={session}>
      ...
      <div className={`grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16 ${activeTab !== 'insights' ? 'no-screen' : ''} ${!reportConfig.sections.aiTechnical ? 'hide-in-report' : ''}`}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }} className={`mb-16 ${activeTab !== 'overview' ? 'no-screen' : ''}`}>
      ...
      <div className={`${activeTab !== 'attendance' ? 'no-screen' : ''} ${!reportConfig.sections.attendance ? 'hide-in-report' : ''}`}>
             ...
             <div style={{ height: 350 }}>
               <ResponsiveContainer width="100%" height="100%">
                 <ComposedChart data={workloadChartData}>
                   ...
                   <Bar yAxisId="left" dataKey="totalHours" name="Total Hours" radius={[3, 3, 0, 0]} barSize={9}>
      ...
      <div className={`${activeTab !== 'overview' ? 'no-screen' : ''} ${!reportConfig.sections.openMeets ? 'hide-in-report' : ''}`}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
      ...
      <div className={`${activeTab !== 'attendance' ? 'no-screen' : ''} ${!reportConfig.sections.aiDeepDive ? 'hide-in-report' : ''}`}>
        <CoachesEyeDeepDive 
          results={results} 
      ...
      <details className={`glass-card mb-16 no-print ${activeTab !== 'overview' ? 'no-screen' : ''}`} style={{ border: 'none', padding: 0, overflow: 'hidden' }}>
        <summary style={{ 
          padding: '2rem', 
          cursor: 'pointer', 
          listStyle: 'none', 
